...
This is a fictional campaign results. The data are simulated based on realistic new merchant offer from [this report by the MD & CH](https://clfee.github.io/python/image/classification/image-classification1/).
:::
