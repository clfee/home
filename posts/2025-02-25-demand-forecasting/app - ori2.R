...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    #sliderInput("obs","Store Number to view:", min = 1, max = 140, value= 55, step = 1),
    radioButtons("obs","Store Number to view:",choices = c(13, 42:43, 55, 86, 94 ), selected = 55),
    sliderInput("forecast_horizon","Forecast Horizon", min = 5, max = 40, value= 10, step = 5)
  ),
